...
import ConfirmEmailPopup
 from "./loginflow/ConfirmEmailPopup";
const features = [
  {
      ...
      <div className="space-y-8 w-full lg:max-w-[1920px] mx-auto">
          ...
          <div className="flex justify-center items-center max-lg:gap-[4em] max-lg:flex-col lg:grid grid-cols-2">
            ...
            <div className="relative grid w-full place-items-center">
              ...
              <div className="absolute top-[50%] left-0 max-sm:left-0 lg:left-[20%] xl:left-[39%] cursor-pointer icon grid grid-cols-[80px_auto] rounded-3xl  w-[23em] px-4 py-3">
                ...
                <div className="z-10 absolute cursor-pointer grid grid-cols-[80px_auto] rounded-3xl w-[23em] h-[6.5em] px-4 py-3 shadow-md bg-white/10 backdrop-blur-xl border border-gray-300 "></div>
              </div>
            </div>
          </div>
        </section>
            ...
            {features.map(({ image, caption }, index) => (
              <div className="md:mt-3 mt-0 grid space-y-3 place-items-center" key={index}>
                <Image
                  ...
                  unoptimized
                />
                <p className="text-center font-baloo font-bold text-2xl">
                  {caption}
                </p>
              </div>
            ))}
        ...
        <section className="grid grid-cols-[1.2fr_1fr] w-[80%] mx-auto py-8">
          ...
          <div className="h-fit my-auto space-y-4">
            <h2 className="text-5xl leading-[1.2em] font-baloo font-bold">
              Turn Pennies into{" "}
      ...
      <footer className="w-full px-[2em] py-[4em] lg:px-[6em] bg-secondary h-fit ">
        <div className="w-full lg:max-w-[2000px] flex gap-3 justify-between mx-auto">
          <div className="my-auto w-[60%] space-y-3">
            <h2 className="font-baloo text-4xl font-bold text-secondary-dark">
              Unlock Your Financial Potential
            </h2>
            <p className="text-white opacity-70 font-inter">{`Discover how easy and enjoyable managing money can be. With Make Cent!, you’ll gain the knowledge, confidence, and tools you need to make informed choices, build lasting wealth, and turn your financial dreams into reality-no matter where you’re starting from.`}</p>
          </div>
