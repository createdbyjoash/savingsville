...
export default function HomeTab() {
  return (
    <div className="w-full h-full flex flex-col gap-8">
      ...
      <section className="grid grid-cols-[60%_40%] w-full h-full gap-8">
        <section className=" w-full h-full">
          ...
          <div className="relative">
            ...
            <div className="relative grid grid-cols-3 gap-[7em] mt-[4em] h-fit place-items-center z-50">
            {lessons.map((lesson, index) =>
              lesson.current ? (
              <div className="flex flex-col gap-2 items-center mt-[-3em] " key={index}>
